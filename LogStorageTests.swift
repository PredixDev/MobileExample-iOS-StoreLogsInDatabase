...
class LogStorageTests: XCTestCase {
    ...
    func testDatabaseReadyObserver()
    {
        ...
        NotificationCenter.default.post(name: InitialReplicationCompleteNotification, object: nil)
...
class MockCDBService : ServiceProtocol
{
    ...
    @objc static func performRequest(_ request: URLRequest, response: HTTPURLResponse, responseReturn: @escaping responseReturnBlock, dataReturn: @escaping dataReturnBlock, requestComplete: @escaping requestCompleteBlock)
    {
        ...
        {
            let failResponse = HTTPURLResponse(url: response.url!, statusCode: HTTPStatusCode.internalServerError.rawValue , httpVersion: HttpVersion, headerFields: response.allHeaderFields as? [String: String])
...
class MockDBService : ServiceProtocol
{
    ...
    @objc static func performRequest(_ request: URLRequest, response: HTTPURLResponse, responseReturn: @escaping responseReturnBlock, dataReturn: @escaping dataReturnBlock, requestComplete: @escaping requestCompleteBlock)
    {
        ...
        {
            thisResponse = HTTPURLResponse(url: response.url!, statusCode: HTTPStatusCode.notFound.rawValue , httpVersion: HttpVersion, headerFields: response.allHeaderFields as? [String: String])!
        }
